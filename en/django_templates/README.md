...
Congrats! Now go ahead and try adding a new post in your Django admin (remember to add published_date!) Make sure you are in the Django admin for your site, https://127.0.0.1/admin. Then refresh your page to see if the post appears there.
